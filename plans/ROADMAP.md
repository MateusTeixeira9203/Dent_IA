...
| **R-99** | **Anotar a radiografia** — paleta de procedimentos (canal, coroa, prótese, implante, pino) e o dentista marca **em cima** do raio-x onde cada um entra | ⏳ pedido dele 10/08, **sem spec**. Depende do bloco `imagem` do R-98a existir. Conceito já no [artefato do R-98](artefatos/R-98-apresentar-visual.html) (Bloco A+), com os 2 modos: paleta é chrome de edição, some ao apresentar. **Decisão pendente:** anotação é overlay (coordenada + tipo, imagem original intocada — recomendo) ou vira documento novo? E pode ser exportada/enviada ao paciente? Aí vira prova que sai da clínica. Símbolos devem sair do catálogo do odontograma, ainda não desenhados | M |
