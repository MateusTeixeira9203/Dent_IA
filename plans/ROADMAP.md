...
> **Ativo:** nenhum — sessão fechada com R-38/R-39b/R-31a/R-41 codados e commitados,
> aguardando suas decisões (ver ESTADO.md) · **Fila:** 15 · **🟡 codado/aplicado, não
> verificado ou não deployado:** 13 · **Concluídos:** 23 · **Congelado:** 1
> **Próximo:** você decide entre push, gate de 2 contas, R-40, R-44 (resto) — ver ESTADO.md
...
| [R-31a](specs/R-31a-paciente-unico-prevencao.md) | Paciente único: **prevenção** — parar de criar duplicata | 🟡 **codado, testado ao vivo e commitado** (31/07) — §3.2, §3.3, §3.1, §3.4 completos. G1/G2/G4 confirmados com bug real achado e corrigido em cada um (ver handoff). G3 (toque no celular) e G5 (toast do agendamento) só confirmados por lógica — dev tooling não deixou ver o toast renderizar. **Ainda sem push** | M |
...
| [R-41](specs/R-41-editar-paciente-completa-cadastro.md) | **Editar paciente fecha o cadastro que o fluxo rápido deixa aberto** — CPF, data de nascimento e responsável de menor | 🟡 **codado, testado ao vivo e commitado** (31/07) — G3-G6 confirmados (CPF duplicado bloqueia com mensagem clara, não colide consigo mesmo, menor revela responsável sem bloquear salvar). G1/G2/G7/G8 só por leitura de código. **Ainda sem push** | M |
...
| ID | Item | Estado | Peso |
|---|---|---|---|
| [R-39](specs/R-39-orcamento-dinheiro-esqueleto-unico.md) | **Orçamento e dinheiro: um esqueleto só** — criar e criado com o mesmo layout, coluna do dinheiro, funil no financeiro | 🟡 **R-39a e R-39b codados, testados ao vivo e commitados** (30/07–31/07) — PDF/WhatsApp adiantados do R-33. R-39b: consistência visual do aceite + coluna "Pago" em `/dashboard/orcamentos`. **Commitado, ainda sem push.** Faltam: gate de 2 contas, mobile completo, R-39c | G |
...
| [R-38](specs/R-38-orcamento-apresentacao-ao-paciente.md) | Orçamento: como o paciente vê — PDF sem preço por item, só total e condição | 🟡 **codado, testado ao vivo e commitado** (30/07–31/07) — migration aplicada, toggle no rodapé, PDF respeita o flag, snapshot do aceite confirmado gravando o flag (G1-G6 verificados). **Ainda sem push** | P |
