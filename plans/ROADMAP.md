...
| [R-78](specs/R-78-coluna-direita-ficha-viva.md) | **Meu dia orientado a fluxo** (redesign completo — não é mais só "coluna direita") — odontograma vira espelho (~555px), lista única "Nesta ficha" com status clicável, perfil do dente como ocupante da direita, "A fazer" e Histórico viram gaveta | ✅ **spec aprovada 08/08 — "exatamente como o artefato"** (dele). Artefato interativo em `plans/artefatos/R-78-meu-dia-fluxo.html`, tokens+geometria extraídos por JS da produção (não estimados), §4.2 tem o contrato pixel-a-pixel (proporção 1,50:1, não "60/40"). 2 achados só apareceram no artefato: arcada real transbordava a 40% (zoom .68 corrige) e o espelho não sincronizava o status (virou gate G8). Perfil do dente quase saiu sem substituto — ele pegou, T4/D4/G12-G14 travam isso (grupo aberto do R-51 dependia dele). Zero código ainda | G |
