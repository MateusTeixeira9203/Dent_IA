# Concluídos — Odonto.IA

> Histórico de itens fechados. **Movido do `ROADMAP.md` em 13/08** na poda: o mapa é o que
> vem pela frente, e 35 linhas de histórico afogavam a fila. Nada foi perdido — só saiu do mapa.
...
| R-82 | Campo mágico trava a aba com documento anexado | 2026-08-08 — confirmado por ele |
| R-75 | Dex não marca "realizado" em upload de histórico só pelo verbo no passado | 2026-08-08 — confirmado por ele |
| [R-62](_arquivo/specs/R-62-campo-magico-entrada-unica.md) | Campo mágico vira entrada única | 2026-08-08 — confirmado por ele |
...
| R-72 | Matar `/consulta` de vez — rotas apagadas, botões redirecionam | 2026-08-07 |
