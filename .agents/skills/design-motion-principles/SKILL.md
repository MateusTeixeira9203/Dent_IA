...
description: "Motion and interaction design expert based on Emil Kowalski, Jakub Krehel, and Jhey Tompkins' techniques. Two modes — build interactive components with purposeful motion, or audit existing animations to catch AI-slop motion patterns (audit emits a structured markdown report). Use when creating, adding, animating, or reviewing UI motion: transitions, hover states, micro-interactions, enter/exit animations, or any motion design work in React, Framer Motion, CSS, or HTML. Provides per-designer perspectives with context-aware weighting."
cpe:
  source: design-motion-principles
  original_path: skills/design-motion-principles/SKILL.md
  original_url: https://github.com/kylezantos/design-motion-principles
  source_commit: 4a9ca879
  license: MIT
  author: kylezantos (Kyle Zantos)
  integrated_at: 2026-06-24
  adaptation: >
    Removida a máquina de relatório HTML do modo audit (output-format.md,
    demo-shell.html, report-template.html ~94KB) — duplicava a design-review e
    feria o princípio anti-inchaço do setup. Audit agora emite markdown inline.
    Conteúdo de princípios, recipes e perspectivas dos designers preservado.
---
...
| [Creation Gotchas](references/creation-gotchas.md) | Codex's failure modes when writing motion | Create mode (always) |
...
> **Nota de adaptação:** os arquivos `output-format.md`, `demo-shell.html` e
> `report-template.html` do upstream (relatório HTML do audit) **não foram
> integrados** — o modo audit emite markdown inline (ver `workflows/audit.md`).
